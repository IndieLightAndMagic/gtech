...
void GLoaderComponent::loadModel(string const &path)
{
...
void GLoaderComponent::processNode(aiNode *node, const aiScene *scene)
{
...
GMeshComponent GLoaderComponent::processMesh(aiMesh *mesh, const aiScene *scene)
{
    // data to fill
    ...
    // 1. diffuse maps
    vector<GTextureComponent> diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");
    textures.insert(textures.end(), diffuseMaps.begin(), diffuseMaps.end());
    // 2. specular maps
    vector<GTextureComponent> specularMaps = loadMaterialTextures(material, aiTextureType_SPECULAR, "texture_specular");
    textures.insert(textures.end(), specularMaps.begin(), specularMaps.end());
    // 3. normal maps
    std::vector<GTextureComponent> normalMaps = loadMaterialTextures(material, aiTextureType_HEIGHT, "texture_normal");
    textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
    // 4. height maps
    std::vector<GTextureComponent> heightMaps = loadMaterialTextures(material, aiTextureType_AMBIENT, "texture_height");
...
vector<GTextureComponent> GLoaderComponent::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
{
    vector<GTextureComponent> textures;
