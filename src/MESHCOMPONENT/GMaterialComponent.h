...
public:
	GMaterialComponent() = default;
	GMaterialComponent(const aiMaterial *pMaterial);
	GMaterialComponent(GMaterialComponent &&otherMaterialComponent) = default;
	GMaterialComponent(const GMaterialComponent &otherMaterialComponent) = default;
    GMaterialComponent& operator=(GMaterialComponent &&otherMaterialComponent) = default;
    GMaterialComponent& operator=(GMaterialComponent &otherMaterialComponent) = default;
